...
//         TODO:
//         fill the whole form
        driver.findElement(By.id("fb_name")).sendKeys("Josef");
        driver.findElement(By.id("fb_age")).sendKeys("30");
        List<WebElement> checkboxes = driver.findElements(By.xpath("//input[@type='checkbox' and @name='language']"));
        for (WebElement checkbox : checkboxes) {
            checkbox.click();
...
//         check fields are filled correctly
        assertEquals("Josef", driver.findElement(By.id("fb_name")).getAttribute("value"));
        System.out.println("Name is ->"+ driver.findElement(By.id("fb_name")).getAttribute("value"));
        assertEquals("30", driver.findElement(By.id("fb_age")).getAttribute("value"));
        System.out.println("Name is ->"+ driver.findElement(By.id("fb_age")).getAttribute("value"));
