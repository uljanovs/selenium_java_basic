...
public class extra1Task {
    ...
    String base_url2 = "https://uljanovs.github.io/site/examples/po";
    String new_url1 = "https://uljanovs.github.io/site/examples/po1";
...
//        click "More > " for the top left element
          driver.findElement(By.className("w3-justify")).click();
//        check that the url now "https://uljanovs.github.io/site/examples/po1"
          assertEquals(new_url1, driver.getCurrentUrl());
...
//        check that the page now is "https://uljanovs.github.io/site/examples/po"
          assertEquals(base_url2, driver.getCurrentUrl());
    }
