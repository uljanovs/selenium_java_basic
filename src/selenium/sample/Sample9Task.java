...
//         * success is seen instead "Green Loaded"
    ...
    public void loadGreenAndBlueBonus() {
        ...
        WebElement loadingGreenAndBlue = driver.findElement(By.id("loading_green_with_blue"));
        assertTrue(loadingGreenAndBlue.isDisplayed());
        assertFalse(startGreenAndBlue.isDisplayed());

        wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("#loading_blue_without_green > label:nth-child(2)")));
        WebElement Green = driver.findElement(By.cssSelector("#loading_blue_without_green > label:nth-child(2)"));
