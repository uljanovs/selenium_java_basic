...
//        check h1 element font-size 64px
        ...
        assertEquals("15px",
                driver.findElement(By.cssSelector("div")).getCssValue("font-size"));
        assertEquals("Verdana, sans-serif",
                driver.findElement(By.cssSelector("div")).getCssValue("font-family"));
        assertEquals("22.5px",
                driver.findElement(By.cssSelector("div")).getCssValue("line-height"));
